    ...
    <Box tag="section" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8">
      <Box className="max-w-6xl mx-auto space-y-12 sm:space-y-16">
        ...
        >
          ...
          <Box className="px-4 sm:px-6 py-2 border-b-2 border-white/20">
            <Box tag="span" className="text-[10px] sm:text-xs font-extrabold uppercase tracking-[0.25em] text-white/60">
              Trusted by
            </Box>
          </Box>
          <Box className="relative overflow-hidden">
            ...
            >
              {[...site.clients, ...site.clients].map((client, index) => (
                <Box tag="span" key={`${client}-${index}`} className="whitespace-nowrap">
                  {client}
                </Box>
              ))}
            </Box>

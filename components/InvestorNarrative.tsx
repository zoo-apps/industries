...
export default function InvestorNarrative() {
  return (
    <Box tag="section" className="relative bg-background border-b-2 border-black overflow-hidden">
      <Box className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 space-y-12 sm:space-y-16 md:space-y-20">
        ...
        >
          <Box className="p-6 sm:p-8 md:p-10 border-b-2 md:border-b-0 md:border-r-2 border-black">
            <Box tag="p" className="text-base sm:text-lg md:text-xl leading-relaxed text-foreground">
            ...
            <Box tag="blockquote" className="mt-6 sm:mt-8 pl-5 sm:pl-6 border-l-[6px] sm:border-l-8 border-black">
              <Box tag="p" className="italic text-sm sm:text-base md:text-lg text-foreground leading-relaxed">
              ...
              <Box tag="cite" className="block mt-2 text-xs sm:text-sm not-italic font-extrabold text-muted-foreground">
                — Start Engine
              </Box>
            </Box>
          </Box>
          <Box className="p-6 sm:p-8 md:p-10 flex flex-col">
            <Box className="text-6xl sm:text-7xl md:text-8xl font-extrabold tracking-tight text-foreground leading-none">
              $113T
            </Box>
            <Box className="mt-3 text-xs sm:text-sm md:text-base font-extrabold uppercase tracking-[0.25em] text-foreground">
              Total addressable
            </Box>
            <Box tag="p" className="mt-5 sm:mt-6 text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed">
        ...
        >
          ...
          >
            {pathSteps.map((s, i) => (
              ...
              >
                ...
                <Box tag="p" className="mt-2 text-xs sm:text-[10px] md:text-xs text-muted-foreground leading-snug">
                  {s.body}
                </Box>
          ...
          <Box className="mt-8 sm:mt-10 grid grid-cols-[56px_1fr] sm:grid-cols-[80px_1fr] md:grid-cols-[100px_1fr] gap-4 sm:gap-6 items-center border-2 border-black p-5 sm:p-6 md:p-8">
            ...
            <div>
              ...
              <Box tag="p" className="mt-1 sm:mt-2 text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        >
          {/* Black header bar */}
          <Box className="bg-black px-4 sm:px-6 py-3 sm:py-4 text-center">
            <Box tag="h3" className="text-xs sm:text-sm md:text-base font-extrabold uppercase tracking-[0.2em] text-white">
          ...
          >
            {aiCompanies.map((c) => (
              ...
              >
                <Box tag="span" className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-black">
                  {c.name}
                </Box>
                <Box tag="span" className="text-base sm:text-xl md:text-2xl font-bold text-black tabular-nums whitespace-nowrap">
                  {c.value}
                </Box>
              </Box>
            ))}
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Box className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 sm:gap-4">
            {sectorTiles.map((t) => (
              <Box
                key={t.label}
              ...
              >
                <Box className="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight leading-none text-foreground">
                  {t.value}
                </Box>
                <Box className="mt-2 text-[10px] sm:text-[11px] md:text-xs font-extrabold uppercase tracking-[0.2em] text-foreground">
                  {t.label}
                </Box>
              </Box>
            ))}
          ...
          {/* Bottom black bar */}
          <Box className="mt-4 sm:mt-5 bg-black border-2 border-black px-4 py-3 text-center">
            <Box tag="span" className="text-xs sm:text-sm md:text-base font-extrabold uppercase tracking-[0.25em] text-white">
